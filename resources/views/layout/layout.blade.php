    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container">
              ...
              <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expand\="false" aria-label="Toggle navigation">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{Route::is('tambah_obat') ? 'active' : ''}}" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                      Obat
                    </a>
                ...
                @if(Auth::user()->role == 'admin')
                  <li class="nav-item">
                    <a class="nav-link" href="{{ route('user.login') }}">Kelola Akun</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('pembelian.admin') }}">Data Pembelian</a>
                </li>
                @endif
                <li class="nav-item">
                ...
                <form class="d-flex" role="search" action="{{ route('obat.data')}}" method="GET">
                    ...
                    <button class="btn btn-outline-success" type="submit">Urutkan Stok</button>
                </form>
                @endif
              </div>
            </div>
